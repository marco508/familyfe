...
// Liste des votes de la maison : barres de progression par option, tap pour
// voter, création (question + options dynamiques), clôture par le chef/créateur.
        ...
        <SectionTitle
          ...
          right={
            <View style={styles.headerActionsRow}>
              ...
              {!isVisiteur ? (
                <Pressable onPress={openModal} style={[styles.addButton, { backgroundColor: colors.candy.blue }, shadows.candyBlue]}>
