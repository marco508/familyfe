// components/sections/ReglesSection.tsx
// ANNEXE V7 — Corps de l'ancien écran `(app)/regles.tsx`, extrait pour être
// rendu comme segment de l'écran "Décisions" (voter une règle EST un vote).
// Ne rend ni fond ni en-tête : l'action "proposer" passe en FAB.
// Règles de la maison, votées (ANNEXE V4).
...
import { Plus, Check, XCircle, Trash2 } from 'lucide-react-native';
import { useMaison } from '../../src/contexts/MaisonContext';
import { useT } from '../../src/i18n';
import { useTheme } from '../../src/contexts/ThemeContext';
import regleService, { Regle } from '../../src/services/regleService';
import { Badge, BottomSheet, CandyButton, CandyCard, CandyInput, EmptyState, Fab, Toggle, VisitorBanner } from '../ui';
...
export default function ReglesSection({ bottomInset = spacing['4xl'] }: Props) {
